...
חסרי תעריף שעתי), **הפקת חשבוניות** מרישומי שעות שטרם חויבו (עם מעקב סטטוס טיוטה/נשלחה/שולמה
לכל חשבונית), ו**יומן תיק** כרונולוגי לתיעוד התפתחויות והחלטות אסטרטגיות. שימו לב: תאריכי
היעד מוזנים ידנית - המערכת אינה מחשבת אוטומטית מועדים סטטוטוריים, מכיוון שחישוב כזה דורש
כללי סדר דין ספציפיים לערכאה שיש לאמת מול הדין בפועל.

מודולים נוספים (מחקר משפטי עם חיפוש רשת, זרימות עבודה, יומן פגישות/לוח שנה) מתוכננים
להמשך הפיתוח בהתאם לצרכים.

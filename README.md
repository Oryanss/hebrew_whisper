...
(הוספה/סימון כבוצע/מחיקה, עם תצוגת הפתוחות תחילה), ו**הפקת חשבונית** כקובץ Word
ישירות מרישומי השעות של התיק (כולל חישוב סכום לחיוב וציון רישומים שהוחסרו בשל
תעריף שעתי חסר). שימו לב: תאריכי היעד מוזנים ידנית - המערכת

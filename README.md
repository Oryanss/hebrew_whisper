...
ו**מעקב מועדים ודדליינים** לכל תיק (כולל תצוגת "מועדים קרובים" בלוח הבקרה). שימו לב:
...
מודולים נוספים (מחקר משפטי עם חיפוש רשת, חיוב שעות, אסטרטגיית תיק, זרימות עבודה,
יומן) מתוכננים להמשך הפיתוח בהתאם לצרכים.

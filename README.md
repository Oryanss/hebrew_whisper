...
המודל. שימו לב: תאריכי היעד מוזנים ידנית - המערכת אינה מחשבת אוטומטית מועדים סטטוטוריים,
מכיוון שחישוב כזה דורש כללי סדר דין ספציפיים לערכאה שיש לאמת מול הדין בפועל.

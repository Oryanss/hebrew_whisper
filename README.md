...
חסרי תעריף שעתי), **יומן תיק** כרונולוגי לתיעוד התפתחויות והחלטות אסטרטגיות, ו**העלאה/הורדה
של מסמכי Word** (`.docx`) לכל מסמך בתיק. שימו לב: תאריכי היעד מוזנים ידנית - המערכת אינה
מחשבת אוטומטית מועדים סטטוטוריים, מכיוון שחישוב כזה דורש כללי סדר דין ספציפיים לערכאה
שיש לאמת מול הדין בפועל.
